...
@Component({
  ...
  <div class="container">
   ...
   <section class="section">
    ...
    <form name="volForm" (ngSubmit)="submitForm(volForm)" #volForm="ngForm">
    <div class="columns">
    <div class="column">
    
      <label class="label">Stewart</label>
      <div class="select is-rounded">
        <select>
        <option *ngFor="let nom of noms" [ngValue]="nom">{{nom.data().nomPrenom }}</option>
        </select>
      </div>
      ...
      <input class="input is-rounded" type="text" 
          ...
          class="input"
          [(ngModel)]="numero_vol"
          #nomInput="ngModel" required placeholder="Rounded input">
...
export class VolComponent {
  ...
  submitForm(volForm:NgForm){
    const message=`Le vol  ${this.numero_vol} a été ajouté`;
    alert(message);
    volForm.reset();
  }
